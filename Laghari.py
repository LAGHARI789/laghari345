...
\033[1;91m☞ Auther     : L4 LAGHARI-MASTER
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME LAGHARI—BALOUCH')
	    os.system('cd $HOME && git clone https://github.com/laghari345/laghari)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('Congratulations B4 LAGHARITool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel B4 BALOCH M4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/K4 LAGHARI && python2 B4.py')
	elif bm =='3':
